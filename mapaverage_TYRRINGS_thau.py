...
for root in ['20','40','60','80','100']:
    ...
    mapoutname   = 'D:/PUMPPROBE/FOFO_SAMENUMBERIMAGES/THAU/thau_tyr_'+root+'fs.xplor'               # output map file
    pdboutname   = 'D:/PUMPPROBE/FOFO_SAMENUMBERIMAGES/THAU/thau_tyr.pdb'
    pseoutname   = 'D:/PUMPPROBE/FOFO_SAMENUMBERIMAGES/THAU/thau_tyr_'+root+'fs.pse'
...
#    PHEs=[3,58,80,90,108,114,152,172,173,181,203]
    ...
    ss="          "
    es=" "
    outstring='ATOM    438  OH  TYR A   1'+xs+ys+zs+os+bs+ss+es+'\n'
    outpdb.write(outstring)
